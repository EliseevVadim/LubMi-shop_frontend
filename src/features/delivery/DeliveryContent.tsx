  ...
  const mobData = [
    {
      title: 'ДОСТАВКА',
      desc: ' <p>\n' +
        '          Уважаемые покупатели, получить свой заказ вы можете транспортной компанией СДЭК \n' +
        '          , а так же DHL в любую точку мира.. Срок формирования и отправки заказа 2–4 рабочих\n' +
    ...
    },
    {
      ...
      desc: ' <p>\n' +
        ...
        '          </p>\n' +
        '          <p>\n' +
        '            Возврат осуществляется при наличии заполненного заявления (<a href="https://drive.google.com/drive/folders/1LaS1TaeEdq1p8zZ162uzPurUXeX64KRi?usp=share_link" target="_blank">скачать «Заявление»</a>)\n' +
        '          </p>\n' +
        '          <p>\n' +
        ...
        '          </p>\n' +
        '          <p>\n' +
        '              Перед отправкой возврата необходимо отправить фото подписанного Заявления на возврат, ' +
        '               фото комплектующих заказа (одежда, акционные товары и подарки, пыльник-мешок, упаковка, брендированный пакет) ' +
        '               на предмет целостности полученного заказа, по номеру <a href="tel:+79180082891">+79180082891</a> (в мессенджере телеграмм @lubmi_ru) После ' +
        '               согласования на возврат в чате с продавцом, осуществить возврат  через тк СДЭК, на указанный адрес продавца. ' +
        '               После отправки возврата прислать трек-номер в чат с продавцом.\n' +
        '          </p>'
    },
    {
      ...
      desc: ' <p>\n' +
        ...
        '          </p>\n' +
        '          <p>\n' +
        '            Для возврата необходимо упаковать вещи и все комплектующие заказа в пакет или коробку, и приложить заявление на возврат.\n' +
        '          </p>\n' +
        '          <p>\n' +
    ...
    },
    {
      ...
      desc: '<p>\n' +
        ...
        '          возврата в пакет и коробку, в которой был получен данный заказ. Отправьте на номер +79180082891\n' +
        ...
        '        </p>\n' +
        '        <p>\n' +
        '          Контактный телефон (+79180082891)\n' +
        '        </p>\n' +
        '        <p>\n' +
      ...
      <div className="delivery">
        ...
        <div className="delivery-desc">
          ...
          <p>
            ...
            Перед отправкой возврата необходимо отправить фото подписанного Заявления на возврат,
            фото комплектующих заказа (одежда, акционные товары и подарки, пыльник-мешок, упаковка, брендированный пакет)
            на предмет целостности полученного заказа, по номеру <a href="tel:+79180082891">+79180082891</a> (в мессенджере телеграмм @lubmi_ru)
            После согласования на возврат в чате с продавцом, осуществить возврат  через тк СДЭК,
            на указанный адрес продавца. После отправки возврата прислать трек-номер в чат с продавцом.
          </p>
          <h2>
          ...
          <p>
            Возврат товара надлежащего качества возможен лишь в том случае, если сохранены его товарный вид, этикетки,
            ярлыки, и потребительские свойства. К товару на возврат приложите заявление на возврат. Упакуйте все вещи для
            возврата в пакет и коробку, в которой был получен данный заказ. Отправьте на номер (+7 918 008-28-91)
            следующую информацию: фотографию заполненного заявления и трек номер отправления. Отправьте посылку курьерской
            компанией СДЭК.
          </p>
          <p>
          ...
          <p>
            Контактный телефон (+7 918 008-28-91)
          </p>
          <p>
            После получения и проверки возврата, покупателю будут перечислены денежные средства на карту или банковский
            счёт в срок до 10ти рабочих дней, для этого необходимо заполнить полные реквизиты для перевода денежных
